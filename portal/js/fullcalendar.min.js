...
m.each(this.split(","),function(ra,sa){if(sa=="title"){fa.append("<span class='fc-header-title'><strong>&nbsp;</strong></span> <a class='fc-monthmap' data-toggle='modal'><i class='fa fa-map'></i> View Monthly Map</a>");ga&&ga.addClass(q+"-corner-right");ga=null}else{var ha;if(a[sa])ha=a[sa];else if(Ja[sa])ha=function(){ma.removeClass(q+"-state-hover");a.changeView(sa)};if(ha){ra=b.theme?jb(b.buttonIcons,sa):null;var da=jb(b.buttonText,sa),ma=m("<span class='fc-button fc-button-"+sa+" "+q+"-state-default'><span class='fc-button-inner'><span class='fc-button-content'>"+(ra?"<span class='fc-icon-wrap'><span class='ui-icon ui-icon-"+
...
ga||ma.addClass(q+"-corner-left");ga=ma}}}});ga&&ga.addClass(q+"-corner-right")});return fa}function g(u){Q.find("strong").html(u);Q.find("a.fc-monthmap").attr({"href":"#map"+getGoodDate(u),"onclick":"generateMap(\'"+getGoodDate2(u)+"\',"+"\'"+getGoodDate(u)+"\',"+"\'"+u+"\')"});}function l(u){Q.find("span.fc-button-"+u).addClass(q+"-state-active")}function j(u){Q.find("span.fc-button-"+u).removeClass(q+"-state-active")}function t(u){Q.find("span.fc-button-"+u).addClass(q+"-state-disabled")}function y(u){Q.find("span.fc-button-"+u).removeClass(q+"-state-disabled")}var S=this;S.render=e;S.destroy=d;S.updateTitle=g;S.activateButton=l;S.deactivateButton=
...
I){var R,V=la+"-widget-header",ea=la+"-widget-content",aa;R="<table class='fc-border-separate' style='width:100%' cellspacing='0'><thead><tr>";for(aa=0;aa<F;aa++)R+="<th class='fc- "+V+"'/>";R+="</tr></thead><tbody>";for(aa=0;aa<w;aa++){R+="<tr class='fc-week"+aa+"'>";for(V=0;V<F;V++)R+="<td class='fc- "+ea+" fc-day"+(aa*F+V)+"'><div>"+(I?"<div class='fc-day-number'/><a class='fc-map' data-toggle='modal' style='float: right;padding: 3px;5px;' ><i class=\"fa fa-map\"></i></a><a class='fc-print' data-toggle='modal' style='float: right;padding: 3px;5px;' ><i class=\"fa fa-print\"></i></a>":"")+"<div class='fc-day-content'><div style='position:relative'>&nbsp;</div></div></div></td>";R+="</tr>"}R+="</tbody></table>";w=
m(R).appendTo(a);K=w.find("thead");i=K.find("th");C=w.find("tbody");P=C.find("tr");E=C.find("td");B=E.filter(":first-child");n=P.eq(0).find("div.fc-day-content div");ab(K.add(K.find("tr")));ab(P);P.eq(0).addClass("fc-first");y(E);Y=m("<div style='position:absolute;z-index:8;top:0;left:0'/>").appendTo(a)}function l(w){var I=w||v==1,R=p.start.getMonth(),V=Ka(new Date),ea,aa,va;I&&i.each(function(wa,Ga){ea=m(Ga);aa=ca(wa);ea.html(ya(aa,$));rb(ea,aa)});E.each(function(wa,Ga){ea=m(Ga);aa=ca(wa);aa.getMonth()==
R?ea.removeClass("fc-other-month"):ea.addClass("fc-other-month");+aa==+V?ea.addClass(la+"-state-highlight fc-today"):ea.removeClass(la+"-state-highlight fc-today");ea.find("div.fc-day-number").text(aa.getDate());var ahj='';var ahd='';if ((Number(aa.getMonth())+1)<10){ahj = '0'}if ((Number(aa.getDate()))<10){ahd = '0'}ea.find("a.fc-map").attr({"href":"#map"+aa.getFullYear()+""+ahj+(Number(aa.getMonth())+1)+""+ahd+aa.getDate(),"onclick":"generateMap(\'"+aa.getFullYear()+"-"+ahj+(Number(aa.getMonth())+1)+"-"+ahd+aa.getDate()+"\', \'"+aa.getFullYear()+""+ahj+(Number(aa.getMonth())+1)+""+ahd+aa.getDate()+"\', \'"+aa.getFullYear()+"-"+ahj+(Number(aa.getMonth())+1)+"-"+ahd+aa.getDate()+"\')"});ea.find("a.fc-print").attr("href","#cf"+aa.getFullYear()+""+ahj+(Number(aa.getMonth())+1)+""+ahd+aa.getDate());I&&rb(ea,aa)});P.each(function(wa,Ga){va=m(Ga);if(wa<v){va.show();wa==v-1?va.addClass("fc-last"):va.removeClass("fc-last")}else va.hide()})}function j(w){o=w;w=o-K.height();var I,R,V;if(L("weekMode")=="variable")I=R=Math.floor(w/(v==1?2:6));else{I=Math.floor(w/v);R=w-I*(v-1)}B.each(function(ea,
...
[]);Y=n.url;M=Jb(n,fa);k+=Y?"<a data-toggle='modal' href='"+Qa(Y)+"'":"<div";k+=" class='"+W.join(" ")+"' id='"+Qa(Y)+"' oncontextmenu='contextMenu(event, this);' style='position:absolute;z-index:8;left:"+r+"px;"+M+"'><div class='fc-event-inner fc-event-skin'"+(M?" style='"+M+"'":"")+">";if(!n.allDay&&B.isStart)k+="<span class='fc-event-time'>"+Qa(T(n.start,n.end,fa("timeFormat")))+" </span>";k+="<span class='fc-event-title'>"+Qa(n.title)+"</span></div>";if(B.isEnd&&ra(n))k+="<div class='ui-resizable-handle ui-resizable-"+(C?"w":"e")+"'>&nbsp;&nbsp;&nbsp;</div>";k+="</"+(Y?
