...
INSERT INTO `customer` (`id`, `lastname`, `firstname`, `maritalstatus`, `numdependent`, `streetaddress1`, `streetaddress2`, `city`, `province`, `postalcode`, `sector`, `owner`, `howlongyear`, `phone`, `workphone`, `email`, `fax`, `lastname2`, `firstname2`, `phone2`, `fax2`, `email2`) VALUES
(62, 'Komgom', 'Willy', 'MARRIED', 2, '34 RUE SAINT ANTOINE', '', 'SAINTE GENEVIEVE', 'QC', 'H9H 2P5', '', 1, 0, '(123) 445-6789', '', 'konawige@hotmail.com', '', 'KAMGANG', 'Shomron', '(514) 651-5902', '', 'sks.phenix@hotmail.com'),
(66, 'Takam', 'Austin', 'SINGLE', 0, '5 Vauquelin', '', 'Saint-Hubert (Longueuil)', 'QC', 'J4L 0A4', '', 1, 2, '(514) 651-5902', '(514) 651-5902', 'austintakam@gmail.com', '', 'Shop', 'Talam', '', '', ''),
...
(5, 1, 'BIFTECK DE CONTRE FILET DE BOEUF C/C', 'hhjs99778', '324219.jpg'),
(7, 1, 'BIFTECK FAUX-FILET DE BŒUF (SPENCER)', 'Try', 'faux-filet-de-boeuf-x2.jpg'),
(9, 1, 'BIFTECK DE SURLONGE DE BŒUF', '', 'beef4.jpg'),
(11, 1, 'BIFTECK AU POIVRE DE BŒUF', '', 'bifteck-poivre.jpg'),
(12, 1, 'BIFTECK DU ROI (INTÉRIEUR RONDE) BŒUF', '', 'bifteck-roi.jpg'),
(13, 1, 'BIFTECK SANDWICH/ SOUS-MARIN DE BŒUF', '', 'cutout-beef.jpg'),
...
(39, 2, 'DINDE ENTIERE GRADE A', '', 'dinde-fraiche-entiere-6kg.jpg'),
(40, 2, 'DINDE HACHÉE', '', 'dinde-hachee.jpg'),
(41, 2, 'POITRINE DE DINDE', '', 'poitrine-de-dinde.jpg'),
...
(87, 7, 'AILES DE POULET DE GRAIN COUPE BUFFALO', '', 'aile-poulet.png'),
(88, 7, 'CUBES DE POULET DE GRAIN', '', 'cube poulet.jpg'),
(89, 7, 'CUISSES DE POULET DE GRAIN', '', 'cuisses poulet.jpg'),
(90, 7, 'HAUT DE CUISSE AVEC OS', '', 'haut de cuisse avec os.jpg'),
(91, 7, 'HAUT DE CUISSE DÉSOSSÉE', '', 'haut de cuisse.jpg'),
(92, 7, 'LANIÈRE DE POITRINE DE POULET DE GRAIN', '', 'beef.jpg'),
(93, 7, 'PILON DE POULET DE GRAIN', '', 'cuisses poulet.jpg'),
...
(98, 7, 'POULET ENTIER DE GRAIN', '', 'poulet-entier.png'),
...
(1, 'admin', 'cbb58ff7f146eddbb11c37236fa27ac8', 'Administrator', 'cedrick.fonkwa@soonatech.com', 1),
(2, 'decaurel', '674f3c2c1a8a6f90461e8a66fb5550ba', 'cedro', 'decaurel@oidjsjfoidsjf.com', 0),
(3, 'austin', '81dc9bdb52d04dc20036dbd8313ed055', 'Austin takam', 'austin@oisdjfodsifjs.com', 0),
...
--
ALTER TABLE `products_category`
  MODIFY `id` tinyint(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `products_details`
--
ALTER TABLE `products_details`
  MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=270;
--
