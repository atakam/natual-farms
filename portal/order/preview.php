...
?>
<div class="notification"><?= gettext("Please review and submit")?>!</div>

<div class="form-style-2">
	<form method="post"  action="../actions/actionadminedit.php" autocomplete="off"> <!-- onsubmit="return validateForm()" -->
		<div class="form-style-2-heading"><?= gettext(" ")?></div>
		<input type="hidden" name="lang" value="<?php echo isset($_GET['lang'])?$_GET['lang']:"fr"?>"/>
		<div class="row">
...
-->
			...
			<div class="section section-20">
				...
				<input type="hidden" class="input-field disabled" tabIndex="-1" name="preview" value="<?php echo $fid;?>" readonly/>
			</div>
		</div>
		<div class="row">
...
<!-- 				<input type="radio" class="checkbox-field" name="married" value="married" /> -->
		...
		<div class="row">
			...
			<div class="section section-25">
				...
				<input type="number" class="input-field disabled" min="0" max="999999" step="1" tabIndex="-1" name="points" id="points" value="<?php echo $rowFC['total_points'];?>" readonly/>
			</div>
			<div class="section section-25">
				<p><?= gettext("Sales Price")?> <span class="required">*</span></p>
				<input type="number" class="input-field mandatory" min="0" max="999999" step="0.01" tabIndex="-1" name="price" id="price" oninput="updateTotal()" value="<?php echo $rowFC['price'];?>" />
			</div>
			<div class="section section-25">
				<p><?= gettext("Rebate")?></p>
				<input type="number" class="input-field"  min="0" max="999999" step="0.01"  name="rebate" id="rebate" value="<?php echo $rowFC['rebate'];?>" oninput="updateTotal()"/>
			</div>
			<div class="section section-25">
				<p><?= gettext("Deposit")?></p>
				<input type="number" class="input-field" min="0" max="999999" step="0.01" name="deposit" id="deposit" value="<?php echo $rowFC['deposit'];?>" oninput="updateTotal()"/>
			</div>
			<div class="section section-25">
				<p><?= gettext("Sub Total")?></p>
				<input type="number" class="input-field disabled" min="0" max="999999" step="0.01" tabIndex="-1" name="subtotal" id="subtotal" value="<?php echo $rowFC['subtotal'];?>" readonly/>
			</div>
			<div class="section section-25">
				<p><?= gettext("Total Balance")?></p>
				<input type="number" class="input-field disabled" min= "0" max="999999" step="0.01"tabIndex="-1" name="total" id="total" value="<?php echo $rowFC['total'];?>" readonly/>
			</div>
		</div>
